...
func (x *DeleteUserRequest) Reset() {
	*x = DeleteUserRequest{}
	mi := &file_proto_users_user_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteUserRequest) Descriptor() ([]byte, []int) {
	return file_proto_users_user_proto_rawDescGZIP(), []int{8}
}
...
func (x *DeleteUserResponse) Reset() {
	*x = DeleteUserResponse{}
	mi := &file_proto_users_user_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteUserResponse) Descriptor() ([]byte, []int) {
	return file_proto_users_user_proto_rawDescGZIP(), []int{9}
}
...
const file_proto_users_user_proto_rawDesc = "" +
	"\n" +
	"\x16proto/users/user.proto\x12\x04user\",\n" +
	"\x04User\x12\x0e\n" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB5Z3github.com/AlexDigitalART/project-protos/proto/userb\x06proto3"

var (
	file_proto_users_user_proto_rawDescOnce sync.Once
	file_proto_users_user_proto_rawDescData []byte
)

func file_proto_users_user_proto_rawDescGZIP() []byte {
	file_proto_users_user_proto_rawDescOnce.Do(func() {
		file_proto_users_user_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_users_user_proto_rawDesc), len(file_proto_users_user_proto_rawDesc)))
	})
	return file_proto_users_user_proto_rawDescData
}

var file_proto_users_user_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_proto_users_user_proto_depIdxs = []int32{
	...
	5, // 10: user.UserService.ListUsers:output_type -> user.ListUsersResponse
...
func file_proto_users_user_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_users_user_proto_rawDesc), len(file_proto_users_user_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
